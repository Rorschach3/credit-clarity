...
### Content Structure
- [ ] Exactly one `<h1>` per page, no more than one.
- [ ] Hierarchical heading order (H1 � H2 � H3)
- [ ] No empty headings
- [ ] Semantic HTML (`<header>`, `<main>`, `<footer>`)
- [ ] Remove duplicate canonical tags
- [ ] Non-www and www variants should resolve to a single canonical tag
- [ ] Make sure site has one LLM.txt file 
- [ ] Make sure site has one sitemap.xml file
