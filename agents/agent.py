...
class Agent:
    ...
    def __init__(
        ...
        Args:
            ...
            client: Synchronous Anthropic client (used for token counting)
            async_client: Async Anthropic client (used for message creation)
        ...
        # Sync client for token counting in MessageHistory
        self.client = client or Anthropic(
            api_key=os.environ.get("ANTHROPIC_API_KEY", "")
        )
        # Async client for non-blocking message creation
    ...
    async def _agent_loop(self, user_input: str) -> Any:  # Returns anthropic.Message
